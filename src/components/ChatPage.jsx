...
const ChatPage=()=>{
     ...
     const [messages, setMessages]=useState([
          {content:'Hello?', sender: 'GM'},
          {content:'Hello?', sender: 'Ali'},
     ]);
     ...
     return <div className="">
          ...
          {/*This is a header*/}
          <header className="dark:border-gray-700 h-15 fixed w-full border dark:bg-gray-800 py-5 shadow flex justify-around items-center">

               <div>
                    <h1 className="text-xl font-sermibold">
                 ...
                 message.sender === currentUser ? "justify-end" : "justify-start"
                    ...
                    <div className={`my-2 ${message.sender === currentUser ? "bg-green-800" : "bg-gray-800" } p-2 max-w-xs rounded`}>
                         <div className="flex flex-row gap-2"> 
                              <img className="h-10 w-10" src={"https://avatar.iran.liara.run/public/43"}
                              alt=""/>
